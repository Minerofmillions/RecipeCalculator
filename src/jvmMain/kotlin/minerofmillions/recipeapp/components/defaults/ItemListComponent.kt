...
class ItemListComponent(context: ComponentContext, override val itemList: List<Item>, private val onItemSelected: (Item) -> Unit, private val onFinished: () -> Unit) : IItemList, ComponentContext by context {
